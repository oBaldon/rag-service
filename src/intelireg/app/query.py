        ...
        results.append(
            {
                ...
                "scores": {
                    ...
                    "semantic_concept_coverage": row.get("semantic_concept_coverage"),
                    "semantic_vocabulary_score": row.get("semantic_vocabulary_score"),
                    "semantic_concepts_matched": row.get("semantic_concepts_matched") or [],
                    "semantic_lookup_match": row.get("semantic_lookup_match", False),
                    "semantic_lookup_rank": row.get("semantic_lookup_rank"),
