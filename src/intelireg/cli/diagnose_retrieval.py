...
def _compact_result(result: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "scores": {
            ...
            "semantic_concept_coverage": scores.get("semantic_concept_coverage"),
            "semantic_vocabulary_score": scores.get("semantic_vocabulary_score"),
            "semantic_concepts_matched": scores.get("semantic_concepts_matched"),
            "semantic_lookup_match": scores.get("semantic_lookup_match"),
            "semantic_lookup_rank": scores.get("semantic_lookup_rank"),
